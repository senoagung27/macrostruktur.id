    ...
    public function detail($slug)
    {
        $data = [
            ...
            'rumah-tinggal' => [
                ...
                'slug' => 'rumah-tinggal',
                // 'image_header' => '<img src="' . asset('assets_2/img/gedung1.png') . '" alt="" class="img-fluid services-img w-100">',
                'image_header' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/JUDUL ATAS/judul-rumah-tinggal-2-lantai-jombang.png') . '" alt="" width="800" class="img-fluid services-img w-100">',
                'image_1' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah-tinggal-2-lantai-mojokerto.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_1' => 'RUMAH TINGGAL 2 LANTAI MOJOKERTO',
                'image_2' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah-tinggal-2-lantai-mojoagung.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_2' => 'RUMAH TINGGAL 2 LANTAI MOJOAGUNG',
                'image_3' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/ruko-2-lantai-banyu-urip-surabaya.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_3' => 'RUKO 2 LANTAI BANYU URIP SURABAYA',
                'image_4' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah-tinggal-2-lantai-jombang-1.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_4' => 'RUMAH TINGGAL 2 LANTAI JOMBANG',
                'image_5' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah-2-lantai-jakarta-barat-p-supriaji.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_5' => 'RUMAH 2 LANTAI JAKARTA BARAT P SUPRIAJI',
                'image_6' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah tinggal,-klinik,-dan-kos-2-lantai-sidoarjo.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_6' => 'RUMAH TINGGAL, KLINIK, DAN KOS 2 LANTAI - SIDOARJO',
                'image_7' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah tinggal-3-lantai-bsd.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_7' => 'RUMAH TINGGAL 3 LANTAI BSD',
                'image_8' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah tinggal-3-lantai-split-level-surabaya.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_8' => 'RUMAH TINGGAL 3 LANTAI SPLIT LEVEL - SURABAYA',
                'image_9' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah tinggal-3-lantai-semi-basement-surabaya.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_9' => 'RUMAH TINGGAL 3 LANTAI SEMI BASEMENT - SURABAYA',
                'image_10' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah tinggal-3-lantai-kemang-village.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_10' => 'RUMAH TINGGAL 3 LANTAI KEMANG VILLAGE',
                'image_11' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah tinggal-2-lantai-surabaya.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_11' => 'RUMAH TINGGAL 2 LANTAI SURABAYA',
                'image_12' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/villa 4-lantai-dago-jawa-barat.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_12' => 'VILLA 4 LANTAI DAGO JAWA BARAT',
                'image_13' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah tinggal-3-lantai-struktur-baja.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_13' => 'RUMAH TINGGAL 3 LANTAI STRUKTUR BAJA',
                'image_14' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah tinggal-3-lantai-surabaya.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_14' => 'RUMAH TINGGAL 3 LANTAI SURABAYA',
                'image_15' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah 2-lantai-surabaya.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_15' => 'RUMAH 2 LANTAI - SURABAYA',
                'image_16' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah dan-klinik-2-lantai-a-kediri.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_16' => 'RUMAH DAN KLINIK 2 LANTAI A KEDIRI',
                'image_17' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/villa-pak-andy-trawas-mojokerto.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_17' => 'VILLA PAK ANDY TRAWAS MOJOKERTO',
                'image_18' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah-tinggal-2-lantai-ubud-bali.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_18' => 'RUMAH TINGGAL 2 LANTAI UBUD BALI',
                'image_19' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah-2-lantai-sidoarjo.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_19' => 'RUMAH 2 LANTAI SIDOARJO',
                'image_20' => '<img src="' . asset('assets_2/img/Portfolio/PORTFOLIO BANGUNAN RUMAH TINGGAL/rumah-dan-kantor-3-lantai-surabaya.png') . '" alt="" height="150" width="200" class="img-fluid services-img w-100">',
                'description_20' => 'RUMAH DAN KANTOR 3 LANTAI SURABAYA',
            ],
            'bangunan-gudang' => [
